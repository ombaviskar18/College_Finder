                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.2s">Filter Page of CET Computer Branch</h1>
                                <!-- breadcrumb Start-->
...
?>
<!-- <form action="filtered_cocet.php" align="center" method="post">
...
<tr>    
    ...
    <td> 
                ...
                <input type="float" class="contact-title" style="font-size: 30px;" name="cocap3"> 
                               <p><br></p>
 ...
 <select class="contact-title" style="font-size: 30px; padding: 50px;"  name="place">
  ...
  <option value="Dumbarwadi">Dumbarwadi</option>
  <option value="Lonavala">Lonavala</option>
  <option value="Sasewadi">Sasewadi</option>
...
<div class="row">
  <div class="col-md-4"><h2 class="contact-title" style="font-size: 30px;" ><b><u>By Percentage</u></b></h2>
    <h2 class="contact-title" style="font-size: 30px;">Enter Percentage you got: </h2>
    <input type="float" class="contact-title" style="font-size: 20px; width: 100%;" name="cocap3" required> </div>
  <div class="col-md-4"><h2 class="contact-title" style="font-size: 30px;" ><b><u>By Location</u></b></h2>
    <h2 class="contact-title" style="font-size: 30px;">Enter Location of College: </h2>
 <select  class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="place">
  ...
  <option value="Khurd">Khurd</option>
    ...
    <!-- <input type="text" class="contact-title" style="font-size: 30px;" name="place" required> </div> -->
  <div class="col-md-4"><h2 class="contact-title" style="font-size: 30px;" ><b><u>By University</u></b></h2>
   <h2 class="contact-title" style="font-size: 30px;">Enter University  </h2>
   <!-- <input type="text" class="contact-title" style="font-size: 30px;" name="university" required> </div> -->
   <select  class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="university">
  <option value="SPPU" selected>Savitribai Phule Pune U.</option>
  <option value="BATU">Dr. Babasaheb Ambedkar Technological U.</option>
  <option value="NMU">North Maharastra University</option>
  <option value="Mumbai University">Mumbai University</option>
</select></div>         
        <div class="col-md-12"><input type="reset" style="font-size: 20px;" class="button button-contactForm boxed-btn">
    </div>
</div>
  <br>
<div class="row" align="center">
  <div class="col-md-12"><input type="submit" value="Filter Colleges" style="font-size: 30px;" class="btn"></div>

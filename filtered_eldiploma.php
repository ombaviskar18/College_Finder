                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.5s">Filtered Colleges For You After Diploma Electrical</h1>
...
$sqlnum = "SELECT COUNT(*) FROM diploma_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
   <?php
    $sqlclgname ="SELECT College_Name , links FROM diploma_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlelcap1 ="SELECT elcap1 FROM diploma_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlelcap2 ="SELECT elcap2 FROM diploma_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlelcap3 ="SELECT elcap3 FROM diploma_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM diploma_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM diploma_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university' ";

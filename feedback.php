                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.5s">Feedback Page</h1>
                                <li class="button-header margin-left "><a href="mainfilterpage.php" class="btn">BACK</a></li>
                            </div>
                        </div>
                    </div>
                </div>          
...
?>
 ...
 <div class="container-fluid" class="comment-form">
         <h1 style="font-size:300%; margin-left: 100px;">Leave a Feedback</h1>
         <form action="thanks.php" method="post">
            ...
            <input type="submit" value="Upload Feedback" class="button button-contactForm btn_1 boxed-btn">
            </div>

...
$sqlnum = "SELECT COUNT(*) FROM cet_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlclgname ="SELECT College_Name , links FROM cet_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcvcap1 ="SELECT cvcap1 FROM cet_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlcvcap1);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcvcap2 ="SELECT cvcap2 FROM cet_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlcvcap2);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcvcap3 ="SELECT cvcap3 FROM cet_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlcvcap3);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM cet_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM cet_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university' ";

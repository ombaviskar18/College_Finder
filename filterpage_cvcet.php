                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.2s">Filter Page of CET Civil Branch</h1>
                                <!-- breadcrumb Start-->
...
?>
<form action="filtered_cvcet.php" align="center" method="post">
...
<tr>    
    ...
    <td> 
                ...
                <input type="float" class="contact-title" style="font-size: 30px;" name="cvcap3"> 
                               <p><br></p>

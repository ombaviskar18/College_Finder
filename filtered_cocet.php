...
$sqlnum = "SELECT COUNT(*) FROM cet_colleges WHERE cocap3 <= '$cocap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlclgname ="SELECT College_Name , links FROM cet_colleges WHERE cocap3 <= '$cocap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcocap1 ="SELECT cocap1 FROM cet_colleges WHERE cocap3 <= '$cocap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcocap2 ="SELECT cocap2 FROM cet_colleges WHERE cocap3 <= '$cocap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcocap3 ="SELECT cocap3 FROM cet_colleges WHERE cocap3 <= '$cocap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM cet_colleges WHERE cocap3 <= '$cocap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM cet_colleges WHERE cocap3 <= '$cocap3' AND Location ='$place' AND University ='$university' ";

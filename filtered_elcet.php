...
$sqlnum = "SELECT COUNT(*) FROM cet_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlclgname ="SELECT College_Name , links FROM cet_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlelcap1 ="SELECT elcap1 FROM cet_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlelcap1);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlelcap2 ="SELECT elcap2 FROM cet_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlelcap2);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlelcap3 ="SELECT elcap3 FROM cet_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlelcap3);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM cet_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM cet_colleges WHERE elcap3 <= '$elcap3' AND Location ='$place' AND University ='$university' ";

                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.5s">Filtered Colleges For You After Diploma Civil</h1>
...
$sqlnum = "SELECT COUNT(*) FROM diploma_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
   <?php
    $sqlclgname ="SELECT College_Name , links FROM diploma_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcvcap1 ="SELECT cvcap1 FROM diploma_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcvcap2 ="SELECT cvcap2 FROM diploma_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlcvcap3 ="SELECT cvcap3 FROM diploma_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM diploma_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM diploma_colleges WHERE cvcap3 <= '$cvcap3' AND Location ='$place' AND University ='$university' ";

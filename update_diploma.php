...
//update query
$sql ="UPDATE diploma_colleges SET cocap1 ='$cocap1',Location ='$place',University ='$univer',cocap2 = '$cocap2',cocap3 = '$cocap3',cvcap1 = '$cvcap1',cvcap2 = '$cvcap2',cvcap3 = '$cvcap3',mecap1 = '$mecap1',mecap2 = '$mecap2',mecap3 = '$mecap3',elcap1 = '$elcap1',elcap2 = '$elcap2',elcap3 = '$elcap3',ejcap1 = '$ejcap1',ejcap2 = '$ejcap2',ejcap3 = '$ejcap3',links = '$links'  where Id='$idi' ";

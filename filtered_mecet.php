                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.5s">Filtered Colleges For You after CET</h1>
...
<table width="1400" align="center" border="0" cellspacing="10" cellpadding="5">
...
$sqlnum = "SELECT COUNT(*) FROM cet_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlclgname ="SELECT College_Name , links FROM cet_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlmecap1 ="SELECT mecap1 FROM cet_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlmecap1);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlmecap2 ="SELECT mecap2 FROM cet_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlmecap2);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlmecap3 ="SELECT mecap3 FROM cet_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlmecap3);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM cet_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM cet_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university' ";

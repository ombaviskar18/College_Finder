...
<head>
    ...
    <title>ADMIN PAGE OF DIPLOMA</title>
                                ...
                                <nav>
                                    <ul id="navigation">                                                                                          
                                        <li class="button-header"> 
                                            <a href="admin_diploma.php"><img src="assets/img/logo/admin.png" height="40" width="40" alt="">DIPLOMA-Admin</a> 
                                            <ul class="submenu">
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">ADMIN PAGE OF DIPLOMA</h1>
                                    <!-- breadcrumb Start-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <form action="insert_diploma.php" method="post">
                        ...
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__caption">
                                    ...
                                    <div class="properties__footer d-flex justify-content-between align-items-center">
                        <form action="delete_diploma.php" method="post">
                        ...
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__caption">
                                    ...
                                    <div class="properties__footer d-flex justify-content-between align-items-center">
                        <form action="update_diploma.php" method="post">
...
<?php
$sqlid ="SELECT Id FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlclgname ="SELECT College_Name FROM diploma_colleges";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT cocap1 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT cocap2 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT cocap3 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title"    style="font-size:90%;" >
<?php
$sqllocation ="SELECT Location FROM diploma_colleges";
...
<td>
    <h2 class="contact-title"    style="font-size:90%;" >
<?php
$sqllocation ="SELECT University FROM diploma_colleges";
...
?> 
   ...
   <br>
   <table width="100%" align="center" border="20" cellspacing="1" cellpadding="5">
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT cvcap1 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT cvcap2 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT cvcap3 FROM diploma_colleges";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT mecap1 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT mecap2 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT mecap3 FROM diploma_colleges";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT elcap1 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT elcap2 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT elcap3 FROM diploma_colleges";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT ejcap1 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT ejcap2 FROM diploma_colleges";
...
<td>
    <h2 class="contact-title" style="font-size:90%;" >
    <?php
    $sqlcutoff ="SELECT ejcap3 FROM diploma_colleges";
...
?> 
 ...
 <tr>
   <td><h2 style="font-size:120%;" class="contact-title" ><b><u>Id</u></b></h2></td>
   <td><h2 style="font-size:100%;" class="contact-title" align="center"><b><u>College Name</u></b></h2></td>  
   <td><h2 style="font-size:120%;" class="contact-title"><b><u>Links</u></b></h2></td>  
      <tr>
   <td>
    <h2 class="contact-title"    style="font-size:120%;" >
<?php
$sqlid ="SELECT Id FROM diploma_colleges";
...
<td>
    <h2 class="contact-title"    style="font-size:120%;" >
<?php
$sqllocation ="SELECT links FROM diploma_colleges";

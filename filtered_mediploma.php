                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.5s">Filtered Colleges For You After Diploma Mechanical</h1>
...
$sqlnum = "SELECT COUNT(*) FROM diploma_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
   <?php
    $sqlclgname ="SELECT College_Name , links FROM diploma_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlmecap1 ="SELECT mecap1 FROM diploma_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlmecap2 ="SELECT mecap2 FROM diploma_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlmecap3 ="SELECT mecap3 FROM diploma_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university'";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM diploma_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM diploma_colleges WHERE mecap3 <= '$mecap3' AND Location ='$place' AND University ='$university' ";

...
$sqlnum = "SELECT COUNT(*) FROM cet_colleges WHERE ejcap3 <= '$ejcap3' AND Location ='$place' AND University ='$university'";
...
?>  
 ...
 <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlclgname ="SELECT College_Name , links FROM cet_colleges WHERE ejcap3 <= '$ejcap3' AND Location ='$place' AND University ='$university'";
...
?>
   ...
   <td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlejcap1 ="SELECT ejcap1 FROM cet_colleges WHERE ejcap3 <= '$ejcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlejcap1);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlejcap2 ="SELECT ejcap2 FROM cet_colleges WHERE ejcap3 <= '$ejcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlejcap2);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqlejcap3 ="SELECT ejcap3 FROM cet_colleges WHERE ejcap3 <= '$ejcap3' AND Location ='$place' AND University ='$university'";

$result =$conn->query($sqlejcap3);
   if($result->num_rows > 0)
{
    while($row =$result->fetch_assoc())
    {
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT Location FROM cet_colleges WHERE ejcap3 <= '$ejcap3' AND Location ='$place' AND University ='$university' ";
...
<td>
    <h2 class="contact-title" style="font-size:110%;" >
    <?php
    $sqllocation ="SELECT University FROM cet_colleges WHERE ejcap3 <= '$ejcap3' AND Location ='$place' AND University ='$university' ";

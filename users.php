                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.5s">Users of College Finder</h1>
...
<table width="1500" align="center" border="5" cellspacing="1" cellpadding="3">
 ...
 <tr>
   ...
   <td><h2 style="font-size:175%;" class="contact-title" align="center"><b><u>Email</u></b></h2></td>
      ...
      <tr>
   <td>
    <h2 class="contact-title"    style="font-size:150%;" >
<?php
$sqlid ="SELECT COUNT(*) FROM users";
...
<form style="margin-left: 700px;" action="delete_user.php" method="post">
                            <p style="font-size:140%;">Enter UserName to DELETE:</p> 
                            <input style="font-size:140%;" type="text" name="user">
                            <br><br>
                            <table>
                                <tr>
                                  <td>    

                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.2s">Filter Page</h1>
                                <!-- breadcrumb Start-->
            ...
            <div class="container">
                ...
                <div class="courses-actives">
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="cetbranches.php"><img src="assets/img/gallery/sb1.gif" alt=""></a>
                            </div>
                            <div class="properties__caption">
                                <br>
                                <center>
                            <h3>Search college by MHT-CET</h3>
                               <br><br> 
                               <li class="button-header"><a href="cetbranches.php" class="btn">Click Here</a></li>
                                </center>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="diplomabranches.php"><img src="assets/img/gallery/sb2.gif" alt=""></a>
                            </div>
                            <div class="properties__caption">
                                  <br>
                                  <center>         
                                    <h3>Search college by DIPLOMA</h3>
                                <br><br> 
                               <li class="button-header"><a href="diplomabranches.php" class="btn">Click Here</a></li>
                               </center>
